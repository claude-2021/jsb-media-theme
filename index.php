...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <img src="<?php echo get_template_directory_uri() ?>/assets/img/logo.png" class="img-fluid animated" alt=""></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
      <div class="row relative">
        <div class="leftBlueArrow"><img src="<?php echo get_template_directory_uri() ?>/assets/img/left_arrow_blue.svg" /></div>
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Your <span class="hero3">growth</span><span class="hero2">-driven media</span> <span class="hero3">partner</span></h1>
